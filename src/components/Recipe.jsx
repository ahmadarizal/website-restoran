            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="md:text-xl text-[1rem]">{recipe.name}</div>
                ...
                <p className="text-[0.85rem] opacity-70 mb-4">
                  ...
                  Temporibus asperiores officia officiis. Deleniti a perferendis
                  ducimus nulla natus veniam quidem accusamus ipsa harum, nemo
                  praesentium in fugit quisquam temporibus saepe?
                </p>
